...
const Footer = () => {
    return (
        <div>
            {/* ----------top----- */}
            <div className="md:flex-row md:gap-[80px] md:w-[100%] flex flex-col gap-[30px] w-[90%]  bg-slate-100 p-[30px]">
            ...
            <div className="md:w-[100%] w-[100%] flex flex-col gap-[10px] items-conter text-center ">
                <p className="text-[13px] text-slate-600 capitalize">creative common attribution 40 internaitonal license</p>
                <p className="text-[13px] text-slate-500 capitalize">@2023 world Academy of science engeeriing and technology</p>
            </div>
        </div>
    );
};
